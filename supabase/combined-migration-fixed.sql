...
-- ========== FIX: Add airtable_id to remaining tables ==========
ALTER TABLE renewal_history ADD COLUMN IF NOT EXISTS airtable_id text;
ALTER TABLE tracker_sessions ADD COLUMN IF NOT EXISTS airtable_id text;
ALTER TABLE daily_reports ADD COLUMN IF NOT EXISTS airtable_id text;
ALTER TABLE ig_metrics ADD COLUMN IF NOT EXISTS airtable_id text;
ALTER TABLE onboarding ADD COLUMN IF NOT EXISTS airtable_id text;
ALTER TABLE utm_campaigns ADD COLUMN IF NOT EXISTS airtable_id text;
