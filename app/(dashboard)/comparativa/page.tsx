...
export default async function ComparativaPage() {
  ...
  const [cashRes, pipelineRes] = await Promise.all([
    ...
    supabase
      .from("leads")
      .select("id, estado, ticket_total, at_cash_7_7, at_cash_cuotas_7_7, fecha_llamada, closer_id")
  ...
  return (
    <ComparativaClient
      ...
      leads={(pipelineRes.data as Pick<Lead, "id" | "estado" | "ticket_total" | "at_cash_7_7" | "at_cash_cuotas_7_7" | "fecha_llamada" | "closer_id">[]) ?? []}
    />
  );
}
