...
const TEAM = [
  { nombre: "Lauti", role: "admin", color: "#8b5cf6" },
  { nombre: "Mel", role: "admin", color: "#8b5cf6" },
  { nombre: "Juanma", role: "closer", color: "#3b82f6" },
  { nombre: "Iv\u00e1n", role: "closer", color: "#3b82f6" },
  { nombre: "Joaqu\u00edn", role: "setter", color: "#22c55e" },
  { nombre: "Jorge", role: "seguimiento", color: "#f97316" },
  { nombre: "Pepito", role: "closer", color: "#3b82f6" },
];
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-zinc-400">
            Sistema de Gesti\u00f3n — Mentor\u00eda Ecommerce
          </p>
        </div>
